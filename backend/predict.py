...
parser.add_argument("--model_file", type=str, default='./best_model/static_graph_params.pdmodel', help="The path to model info in static graph.")
parser.add_argument("--params_file", type=str, default='./best_model/static_graph_params.pdiparams', help="The path to parameters in static graph.")
...
parser.add_argument("--pinyin_vocab_file_path", type=str, default="./best_model/pinyin_vocab.txt", help="pinyin vocab file path")
